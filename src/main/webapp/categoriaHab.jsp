<%-- 
    Document   : CateggoriaHab
    Created on : 15 jun. 2024, 22:40:30
    Author     : LYOGI
--%>
                        ...
                        <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="CategoriaHabControlador?menu=CategoriaHab&&accion=Guardar" method="post" id="">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="staticBackdropLabel">Registrar Categoría</h1>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">

                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="text" name="nombreCategoria" placeholder="name@example.com" />
                                                <label for="inputEmail">Descripción Categoría</label>
                                            </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple" class="table table-striped">
                                    ...
                                    <tbody>
                                    <c:forEach items="${listaCategoriaHab}" var="ch"> 
                                        <tr>
                                            <td class="idpersona">${ch.getNombreCategoria()}</td>
                                        <td>
                                            <a class="btn btn-warning" href="CategoriaHabControlador?menu=CategoriaHab&&accion=Editar&&idch=${p.getIdCategoria()}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                                <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z"/>
                                                </svg>
                                            </a>
                                            <a class="btn btn-danger" href="CategoriaHabControlador?menu=CategoriaHab&&accion=Eliminar&&idch=${p.getIdCategoria()}" onclick="mensajeEliminar()">
