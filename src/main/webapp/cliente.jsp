                        ...
                        <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="ClienteControlador?menu=Cliente&&accion=Guardar" method="post">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="staticBackdropLabel">Registrar Cliente</h1>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-5">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        ...
                                                        <select name="tipoDocC" id="tipoDocC" class="form-select" placeholder="Enter your first name">
                                                            <option value="">----------------</option>
                                                            <option value="DNI" ${param.tipoDoc.equals("RUC")? "selected" : ""}>RUC</option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="inputLastNameC" type="text" name="nDocuemntoC" placeholder="Enter your last name" />
                                            ...
                                            <div class="form-floating mb-3 mb-md-3 col-md-7">
                                                <input class="form-control" id="inputFirstName" type="text" name="nombresC" placeholder="Enter your first name" />
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="inputLastName" type="text" name="aPaternoC" placeholder="Enter your last name" />
                                                        <label for="inputLastName">Apellido Paterno</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="inputLastName" type="text" name="aMaternoC" placeholder="Enter your last name" />
                                            ...
                                            <div class="form-floating mb-3 mb-md-3 col-md-5">
                                                <input class="form-control" id="inputFirstName" type="text" name="telefonoC" placeholder="Enter your first name" />
                                                <label for="inputFirstName">Teléfono - Celular</label>
                                            </div>


                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="email" name="correoC" placeholder="name@example.com" />
                                ...
                                <table id="datatablesSimple" class="table table-striped">
                                    ...
                                    <tbody>
                                        <c:forEach items="${listaCliente}" var="c"> 
                                            <tr>
                                                <td class="idcliente">${c.getIdCliente()}</td>
                                                <td class="tipoDocumento">${c.getTipoDocuemnto()}</td>
                                                <td class="documento">${c.getDocumento()}</td>
                                                <td class="nombres">${c.getNombres()}</td>
                                                <td class="apePaterno">${c.getApellidoPaterno()}</td>
                                                <td class="apeMaterno">${c.getApellidoMaterno()}</td>
                                                <td class="telefono">${c.getTelefono()}</td>
                                                <td class="correo">${c.getCorreo()}</td>
                                                <td>
                                                    <a class="btn btn-warning" href="ClienteControlador?menu=Cliente&&accion=Editar&&idc=${p.getIdCliente()}">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                        <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                                        <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z"/>
                                                        </svg>
                                                    </a>
                                                    <a class="btn btn-danger" href="ClienteControlador?menu=Cliente&&accion=Eliminar&&idc=${p.getIdCliente()}" onclick="mensajeEliminar()">
