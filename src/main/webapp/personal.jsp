<%-- 
    Document   : personal
    Created on : 7 jun. 2024, 16:41:34
    Author     : LYOGI
--%>
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseConfig" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="NivelHabControlador?menu=NivelHab&&accion=Listar">Nivel Habitación</a>
                                </nav>
                            </div>
                            <div class="collapse" id="collapseConfig" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="PersonalControlador?menu=Personal&&accion=Guardar" method="post" id="">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-5">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        ...
                                                        <select name="tipoDoc" id="tipoDoc" class="form-select" placeholder="Enter your first name">
                                                            <option value="">----------------</option>
                                                            <option value="DNI" ${param.tipoDoc.equals("DNI")? "selected" : ""}>DNI</option>
                                                            <option value="CE" ${param.tipoDoc.equals("CE")? "selected" : ""}>Carnet Extranjería</option>
                                                            <option value="PASS" ${param.tipoDoc.equals("PASS")? "selected" : ""}>Pasaporte</option>
                                                            <option value="DIE" ${param.tipoDoc.equals("DIE")? "selected" : ""}>Documento identidad de extranjero</option>
                                                        </select>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="inputLastName" type="text" name="nDocuemnto" placeholder="Enter your last name" />
                                                        <label for="inputLastName">Número documento</label>
                                                    </div>
                                                </div>
                                            </div>


                                            <div class="form-floating mb-3 mb-md-3 col-md-7">
                                                <input class="form-control" id="inputFirstName" type="text" name="nombres" placeholder="Enter your first name" />
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="inputLastName" type="text" name="aPaterno" placeholder="Enter your last name" />
                                                        <label for="inputLastName">Apellido Paterno</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="inputLastName" type="text" name="aMaterno" placeholder="Enter your last name" />
                                                        <label for="inputLastName">Apellido Materno</label>
                                                    </div>
                                                </div>
                                            </div>

                                            <div class="form-floating mb-3 mb-md-3 col-md-5">
                                                <input class="form-control" id="inputFirstName" type="text" name="telefono" placeholder="Enter your first name" />
                                                <label for="inputFirstName">Teléfono - Celular</label>
                                            </div>
                                            ...
                                            <div class="form-floating mb-3 mb-md-3 col-md-5">
                                                <select name="estado" id="estado" class="form-select" placeholder="Enter your first name">
                                                    <option value="">----------------</option>
                                                    <option value="A" ${param.estado.equals("Activo")? "selected" : ""}>Activo</option>
                                                    <option value="I" ${param.estado.equals("Inactivo")? "selected" : ""}>Inactivo</option>
                                                </select>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple" class="table table-striped">
                                    ...
                                    <tbody>
                                        <c:forEach items="${listaPersonal}" var="p"> 
                                            <tr>
                                                <td class="idpersona">${p.getIdPersonal()}</td>
                                                <td class="tipoDocumento">${p.getTipoDocumento()}</td>
                                                <td class="documento">${p.getDocumento()}</td>
                                                <td class="nombres">${p.getNombres()}</td>
                                                <td class="apePaterno">${p.getApellidoPaterno()}</td>
                                                <td class="apeMaterno">${p.getApellidoMaterno()}</td>
                                                <td class="telefono">${p.getTelefono()}</td>
                                                <td class="correo">${p.getCorreo()}</td>
                                                <td >
                                                    <c:if test="${p.getEstado() eq 'A'}">
                                                        <span class="badge text-bg-success">Activo</span>
                                                    </c:if>
                                                    <c:if test="${p.getEstado() eq 'I'}">
                                                        <span class="badge text-bg-dark">Inactivo</span>
                                                    </c:if>     
                                                </td>
                                                <td>
                                                    <a class="btn btn-warning" href="PersonalControlador?menu=Personal&&accion=Editar&&idp=${p.getIdPersonal()}">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                        <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                                        <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z"/>
                                                        </svg>
                                                    </a>
                                                    <a class="btn btn-danger" href="PersonalControlador?menu=Personal&&accion=Eliminar&&idp=${p.getIdPersonal()}" onclick="mensajeEliminar()">
                        ...
                        <a class="btn btn-success" href="PersonalControlador?menu=Personal&&accion=ExportarExcel">Exportar Excel</a>
                    </div>
                </main>
